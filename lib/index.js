(function() {
  var EOL, Q, async, fs, getLangResource, getProperty, gutil, langRegExp, path, replaceProperties, through;
        ...
        return function(langResource) {
          ...
          if (file._lang_) {
            ...
            langResource.LANG_LIST.forEach(function(lang) {
              var newFile, newFilePath, originPath, trace;
              originPath = file.path;
              newFilePath = originPath.replace(/\.src\.html$/, '\.html');

              /**
               * If the option `createLangDirs` is set, save path/to/foo.html
               * to path/to/lang/foo.html. Otherwise, save to path/to/foo-lang.html
               */
