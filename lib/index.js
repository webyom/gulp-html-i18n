(function() {
  var EOL, Q, YAML, async, createRegExpFromDelimiters, defaultDelimiters, defaultLangRegExp, defaultRenderEngine, engines, extend, fs, getLangResource, getProperty, gutil, handleUndefined, mustache, mustacheReplaceProperties, path, regexReplaceProperties, replaceProperties, restoreMustacheLookup, supportedType, through, wrapMustacheLookUp,
    ...
    return through.obj(function(file, enc, next) {
      ...
      return getLangResource(langDir, opt).then((function(_this) {
        return function(langResource) {
          var _filename_, _filepath_, _langs_, content;
          ...
          if (file._lang_ && file.runId === runId) {
            ...
            _langs_.forEach(function(lang) {
              var newFile, newFilePath, originPath, ref, ref1, trace, tracePath;
              originPath = file.path;
              newFilePath = originPath.replace(/\.src\.html$/, '\.html');
              if (opt.createLangDirs) {
                if (((ref = file.base) != null ? ref.slice(-1) : void 0) !== path.sep) {
                  file.base += path.sep;
                }
              ...
              if (opt.trace) {
                ...
                if ((ref1 = path.extname(originPath).toLowerCase()) === '.html' || ref1 === '.htm' || ref1 === '.xml') {
  ...
  module.exports.resolveReference = function(opt) {
    ...
    return through.obj(function(file, enc, next) {
      var lang, relPath;
      if (file.isNull()) {
        return this.emit('error', new gutil.PluginError('gulp-html-i18n:resolveReference', 'File can\'t be null'));
      }
      if (file.isStream()) {
        return this.emit('error', new gutil.PluginError('gulp-html-i18n:resolveReference', 'Streams not supported'));
      }
      relPath = path.relative(langDir, file.path);
      if (relPath.indexOf('.') === 0) {
        return this.emit('error', new gutil.PluginError('gulp-html-i18n:resolveReference', 'Not language resource file'));
      }
  ...
  module.exports.restorePath = function() {
    return through.obj(function(file, enc, next) {
      if (file.isNull()) {
        return this.emit('error', new gutil.PluginError('gulp-html-i18n:restorePath', 'File can\'t be null'));
      }
      if (file.isStream()) {
        return this.emit('error', new gutil.PluginError('gulp-html-i18n:restorePath', 'Streams not supported'));
      }
  ...
  module.exports.i18nPath = function() {
    return through.obj(function(file, enc, next) {
      if (file.isNull()) {
        return this.emit('error', new gutil.PluginError('gulp-html-i18n:i18nPath', 'File can\'t be null'));
      }
      if (file.isStream()) {
        return this.emit('error', new gutil.PluginError('gulp-html-i18n:i18nPath', 'Streams not supported'));
      }
      if (file._i18nPath_) {
  ...
  module.exports.jsonSortKey = function(opt) {
    ...
    return through.obj(function(file, enc, next) {
      ...
      if (file.isNull()) {
        return this.emit('error', new gutil.PluginError('gulp-html-i18n:jsonSortKey', 'File can\'t be null'));
      }
      if (file.isStream()) {
        return this.emit('error', new gutil.PluginError('gulp-html-i18n:jsonSortKey', 'Streams not supported'));
      }
  ...
  module.exports.validateJsonConsistence = function(opt) {
    ...
    return through.obj(function(file, enc, next) {
      ...
      if (file.isNull()) {
        return this.emit('error', new gutil.PluginError('gulp-html-i18n:validateJsonConsistence', 'File can\'t be null'));
      }
      if (file.isStream()) {
        return this.emit('error', new gutil.PluginError('gulp-html-i18n:validateJsonConsistence', 'Streams not supported'));
      }
      compare = (function(_this) {
        return function(src, target, targetFilePath, compareKey) {
          ...
          error = function() {
            ...
            return _this.emit('error', new gutil.PluginError('gulp-html-i18n:validateJsonConsistence', 'validateJsonConsistence failed'));
          };
