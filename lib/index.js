(function() {
  var EOL, Q, async, createRegExpFromDelimiters, defaultDelimiters, defaultLangRegExp, defaultRenderEngine, extend, fs, getLangResource, getProperty, gutil, handleUndefined, mustache, mustacheReplaceProperties, path, regexReplaceProperties, replaceProperties, supportedType, through,
  ...
  regexReplaceProperties = function(langRegExp, content, properties, opt, lv) {
  ...
  mustacheReplaceProperties = function(delimiters, content, properties, opt, lv) {
  ...
  replaceProperties = function(content, properties, opt, lv) {
    ...
    if (renderEngine === 'mustache') {
      return mustacheReplaceProperties(delimiters, content, properties, opt, lv);
    } else if (renderEngine === 'regex') {
      return regexReplaceProperties(langRegExp, content, properties, opt, lv);
    }
  };
