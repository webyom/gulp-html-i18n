(function() {
  var EOL, Q, async, defaultLangRegExp, defaultRenderEngine, extend, fs, getLangResource, getProperty, gutil, handleUndefined, mustache, mustacheReplaceProperties, path, regexReplaceProperties, replaceProperties, supportedType, through,
  ...
  mustacheReplaceProperties = function(langRegExp, content, properties, opt, lv) {
  ...
  replaceProperties = function(content, properties, opt, lv) {
    ...
    if (renderEngine === 'mustache') {
      return mustacheReplaceProperties(langRegExp, content, properties, opt, lv);
